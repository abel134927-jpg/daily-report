...
# ==================== 關鍵字分類 ====================
# 大陸筆電品牌（只有命中這裡才算筆電新聞）
# 重點關注：機械革命、聯想系列、ROG、七彩虹、機械師
LAPTOP_CN_KEYWORDS = [
    # 通用詞
    "筆記本", "笔记本", "筆電", "笔电", "遊戲本", "游戏本",
    "輕薄本", "轻薄本", "notebook", "laptop",
    # 重點品牌
    "機械革命", "mechrev",
    "聯想", "联想", "拯救者", "legion", "thinkpad", "ideapad", "lenovo yoga",
    "rog", "玩家國度", "华硕笔记本", "vivobook", "zenbook",
    "七彩虹", "colorful iGame",
    "機械師", "machenike",
    # 其他中國市場品牌
    "神舟", "hasee",
...
# 排除筆電新聞中不需要的品牌（在 prompt 層過濾）
LAPTOP_EXCLUDE_KEYWORDS = ["apple", "macbook", "mac pro", "mac mini", "imac"]

# GPU / CPU / 其他硬體關鍵字（DIY 市場 / 消費端視角）
OTHER_HW_KEYWORDS = [
    # 顯卡 - 型號
    "顯卡", "显卡", "gpu", "rtx 5", "rtx 4", "rtx 3", "geforce",
    "radeon", "rx 9", "rx 8", "rx 7", "arc ", "intel arc",
    # 顯卡 - 每日行情 / 甜品卡
    "甜品卡", "显卡行情", "顯卡行情", "显卡价格", "顯卡價格",
    "今日報價", "今日报价", "最低价", "最低價", "最划算",
    "性价比显卡", "性價比顯卡", "值不值得买", "值不值得買",
    "顯卡推薦", "显卡推荐", "入门显卡", "入門顯卡",
    # CPU
    "ryzen", "core ultra", "core i9", "core i7", "core i5",
    "cpu", "處理器", "处理器",
    # 主機板 / 記憶體 / 儲存
    "主板", "主機板", "ddr5", "ddr4", "內存", "内存",
    "ssd", "nvme", "固態硬碟", "固态硬盘",
    # 電源 / 散熱 / 機箱
    "電源", "电源", "散熱", "散热", "水冷", "機箱", "机箱",
    # DIY / 裝機
    "裝機", "装机", "配置推薦", "配置推荐", "性價比", "性价比",
    # 價格行情
    "漲價", "涨价", "降價", "降价", "國補", "国补", "活動價", "促銷",
]
...
【篩選規則 - 嚴格執行，其餘一律忽略】
✅ 筆電：重點品牌（機械革命、聯想/拯救者、ROG、七彩虹、機械師）的新品發布、評測結論、降價促銷
✅ 顯卡：每日行情漲跌、當前甜品卡是誰、哪款性價比最高、哪家最便宜
✅ 顯卡：新品發布含首發價、現貨價格、評測結論
✅ CPU：新品發布含價格、行情漲跌、裝機推薦搭配
✅ DIY 配件：記憶體/SSD/電源等明顯漲降價、熱門推薦型號
✅ 裝機建議：各預算最推薦的配置（B站/知乎/小紅書口碑）
❌ 排除：蘋果 Mac/MacBook 相關、企業財報、工廠產能、太空/科學、遊戲劇情、純軟體新聞
